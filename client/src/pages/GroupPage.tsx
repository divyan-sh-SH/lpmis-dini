...
const emptyCart = (group_id?: string): CartItemCreate => ({
  stock_item: '',
  store_name: '',
  cost: 0,
  description: '',
...
export default function GroupPage() {
  ...
  const [txForm, setTxForm] = useState<TransactionCreate>(emptyTransaction(groupId));
  const [stockForm, setStockForm] = useState<StockCreate>(emptyStock(groupId));
  const [cartForm, setCartForm] = useState<CartItemCreate>(emptyCart(groupId));
  ...
  return (
    <div className="w-full">
      <header className="mb-5">
        ...
        <p className="text-slate-500 mt-1">Manage group transactions, stocks, and cart items.</p>
      </header>
