...
4. /groups -> Group View 
    ...
    Also There will a button to create group. It will open a modal having Feilds -> Group Name and Add member. In add member -> It will show me multi select drop down of all the users from tha API on selecting which I can make a group with those users. Group Name and Atleast on member will be required to enable create group button on the Create Group Modal. 
